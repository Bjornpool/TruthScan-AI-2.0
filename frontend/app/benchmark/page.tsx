...
const i18n = {
  pl: {
    ...
    colFake:     "Fake prob%",
    colSent:     "Sentyment",
    noData:      "Brak danych — kliknij przycisk powyżej aby uruchomić analizę",
    errPrefix:   "Błąd:",
  ...
  en: {
    ...
    colFake:     "Fake prob%",
    colSent:     "Sentiment",
    noData:      "No data — click the button above to start the analysis",
    errPrefix:   "Error:",
  ...
  no: {
    ...
    colFake:     "Fake prob%",
    colSent:     "Sentiment",
    noData:      "Ingen data — klikk knappen ovenfor for å starte analysen",
    errPrefix:   "Feil:",
